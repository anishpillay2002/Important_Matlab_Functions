...
function [nextid,left,Time_data,Vel_data,LZH_data,LLH_data] = seg_data (data,nextid,code,left,Time_data,Vel_data,LZH_data,LLH_data)
...
elseif code==2
LLH_data=padcat(LLH_data,slice);
end
end
end